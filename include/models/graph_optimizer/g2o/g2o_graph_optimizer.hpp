...
#include "models/graph_optimizer/g2o/edge/edge_se3_priorxyz.hpp"
#include "models/graph_optimizer/g2o/edge/edge_se3_priorquat.hpp"
...
class G2oGraphOptimizer: public InterfaceGraphOptimizer {
  ...
  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    ...
    // 输出数据
    bool GetOptimizedPose(std::deque<Eigen::Matrix4f,Eigen::aligned_allocator<Eigen::Matrix4f>>& optimized_pose) override;
